...
var _ = Describe("CF PHP Buildpack", func() {
	...
	It("deploying a basic PHP app", func() {
		...
		if cutlass.Cached {
			...
			Expect(app.Stdout.String()).To(MatchRegexp(`Downloaded \[file://.*/dependencies/https___s3.amazonaws.com_suse-buildpacks-staging_dependencies_php_php-.*-linux-x64-.*.tgz\] to \[/tmp\]`))
		}
	})
